                ...
                <div class="flex flex-col md:flex-row  md:items-center justify-between mt-6">
                    ...
                    <div class="flex items-center space-x-2 mt-4 md:mt-0" x-data="{ isOpen: false }">
                        ...
                        <div class="relative">
                            ...
                            <ul x-cloak x-show="isOpen" x-transition.origin.top.left @click.away="isOpen = false"
                                ...
                                @can('update', $idea)
                                <li>
                                    <a href="" @click.prevent="isOpen = false, $dispatch('custom-show-edit-modal')"
                                ...
                                <li>
                                    @can('delete', $idea)
                                    <a href="" @click.prevent="isOpen = false, $dispatch('custom-show-delete-modal')"
                                        class="hover:bg-gray-100 block px-5 py-3 transition duration-150 ease-in">
                                        Delete Idea
                                    </a>
                                    @endcan
                    ...
                    <div class="flex items-center md:hidden mt-4 md:mt-0">
                        <div class="bg-gray-100 text-center rounded-xl h-9 px-4 py-2 pr-8">
                            <div class="text-sm font-bold leading-none @if ($hasVoted) text-theme-blue-primary @endif">
                                {{ $votesCount }}</div>
