        ...
        <div x-show.transition.origin.bottom.duration.300ms="isOpen"
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <form wire:submit.prevent="updateComment" action="#" method="POST" class="space-y-4 px-4 py-6">
                    <div>
                        <textarea autofocus x-ref="editComment" wire:model.defer="body" name="idea" id="idea" cols="30"
                            rows="4" class="w-full bg-gray-100 rounded-xl border-none placeholder-gray-900 text-sm px-4 py-2"
                            placeholder="Edit comment" required></textarea>
                        @error('body')
                    ...
                    <div class="flex items-center justify-between space-x-3">
                        ...
                        <button type="submit"
                            class="flex items-center justify-center w-1/2 h-11 text-xs bg-theme-blue-primary text-white font-semibold rounded-xl border border-theme-blue-primary hover:bg-theme-blue-hover transition duration-150 ease-in px-6 py-3">
